...
public class GoogleAnalyticsClient  {
	...
	*/
	...
	public void SendTimedEventHit(string category, string action, string label, float time, bool trackLevelName = false) {
		SendEventHit(category, action, label, Mathf.RoundToInt(time * 1000), trackLevelName);
	}
